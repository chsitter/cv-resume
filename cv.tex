...
\begin{expertise}
    ...
    \expertiseitem[Technologies]{gcc/gdb, llvm/lldb, valgrind, strace, make, Premake, Cmake, OpenSSL, Gradle, vim, tmux, bash, JVM, TensorFlow, scikit-learn, TCP/IP, UDP, HTTP, XML, UML, databases, Docker, Jenkins, Travis CI, Bitcoin, Ethereum}
